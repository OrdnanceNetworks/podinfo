...
import (
	...
	"github.com/ordnancenetworks/podinfo/pkg/api"
	"github.com/ordnancenetworks/podinfo/pkg/grpc"
	"github.com/ordnancenetworks/podinfo/pkg/signals"
	"github.com/ordnancenetworks/podinfo/pkg/version"
...
func main() {
	...
	viper.SetDefault("ui-logo", "https://raw.githubusercontent.com/ordnancenetworks/podinfo/gh-pages/cuddle_clap.gif")

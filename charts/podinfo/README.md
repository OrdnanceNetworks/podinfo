...
[GitHub Container Registry](https://github.com/ordnancenetworks/podinfo/pkgs/container/charts%2Fpodinfo)
...
```console
$ helm upgrade -i my-release oci://ghcr.io/ordnancenetworks/charts/podinfo
```

To verify a chart with Cosign:

```console
$ cosign verify ghcr.io/ordnancenetworks/charts/podinfo:<VERSION>
```
...
| `image.repository`                | `ordnancenetworks/podinfo` | Image repository                                                                                                       |
